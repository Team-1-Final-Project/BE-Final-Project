...
public class BoardController {
    ...
    public ResponseDto<?> createBoard(@AuthenticationPrincipal UserDetailsImpl userDetails, @RequestPart(value = "data") BoardRequestDto boardRequestDto, @RequestPart(required = false, value = "boardImage")  MultipartFile uploadImage) throws IOException {
    ...
    public ResponseDto<?> alterBoard(@PathVariable Long id, @AuthenticationPrincipal UserDetailsImpl userDetails, @RequestPart(value = "data") BoardRequestDto boardRequestDto, @RequestPart(required = false, value = "boardImage")  MultipartFile uploadImage) throws IOException {

...
public class SearchController {
  ...
  public ResponseDto<List<BoardResponseDto>> searchBoard (@RequestParam(value = "keyword") String keyword) {
    return ResponseDto.success(searchService.searchBoard(keyword));
  }

  //모임검색하기
  @GetMapping("/meeting/search")
  public ResponseDto<List<MeetingGetAllResponseDto>> searchMeeting (@RequestParam(value = "keyword") String keyword) {

...
sudo nohup java -jar -javaagent:/home/ubuntu/scouter/agent.java/conf/scouter.agent.jar -DScouter.config=/home/ubuntu/scouter/agent.java/conf/earth-us.conf -Djasypt.encryptor.password=$ENCRYPT_PASSWORD $JAR_FILE > $APP_LOG 2> $ERROR_LOG &
